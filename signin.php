...
<?php 
      ...
      if(isset($login))
      {
        // echo "<pre>";
        // print_r($_POST);
        $sql="select email_id,pass,type,status from website_signup where email_id='$username' and pass='$password'";
        ...
        $type=$row['type'];
        $status=$row['status'];
        if($username==$email_id and $password==$pass)
        {
        ...
        {
            echo "User name or password is worng ";
        }
      }
                ...
                <div class="d-flex justify-content-center form_container">
                    <form method="post">
                        <div class="input-group mb-3">
                            ...
                            <input type="text" name="username" class="form-control input_user"  placeholder="Eamil id or Mobile number">
                        </div>
